...
func (c *contactRepository) Get(ctx context.Context) ([]*Contact, error) {
...
func (c *contactRepository) GetContactByEmail(email string, ctx context.Context) (*Contact, error) {
